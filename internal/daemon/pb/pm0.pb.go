...
func (x *RenameRequest) Reset() {
	*x = RenameRequest{}
	mi := &file___proto_pm0_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenameRequest) Descriptor() ([]byte, []int) {
	return file___proto_pm0_proto_rawDescGZIP(), []int{12}
}
...
var file___proto_pm0_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file___proto_pm0_proto_goTypes = []any{
	(*Unit)(nil),             // 0: pm0.Unit
...
func file___proto_pm0_proto_init() {
	...
	file___proto_pm0_proto_msgTypes[0].OneofWrappers = []any{}
	file___proto_pm0_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
